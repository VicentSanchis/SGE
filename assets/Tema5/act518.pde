...
void draw() {
  ...
  switch (opcio) {
    ...
    case BINARIA:
      mostraEnters (arrayEnters, 440, 50);
      executaBinaria ();
    break;
...
/**
* Ordena utilitzant l'algorisme de selecció un array d'enters que es passa per paràmetre
* @parm un array unidimensional d'enters
* @return void
*/
void seleccio (int [] array) {
...
/**
* Ordena utilitzant l'algorisme d'inserció un array d'enters que es passa per paràmetre
* @parm un array unidimensional d'enters
* @return void
*/
...
/**
* Ordena utilitzant l'algorisme de la bombolla un array d'enters que es passa per paràmetre
* @parm un array unidimensional d'enters
* @return void
*/
void bombolla (int [] array) {
  for (int i = 0; i < array.length-1; i++) {
    for(int j = i + 1; j < array.length; j++) {
      if (array [i] > array [j]) {
        int canvi = array [i];
...
/**
* Ordena utilitzant l'algorisme del shell sort un array d'enters que es passa per paràmetre
* @parm un array unidimensional d'enters
* @return void
*/
...
/**
* Ordena utilitzant l'algorisme del Quciksort un array d'enters que es passa per paràmetre
* @parm un array unidimensional d'enters
* @param primer indica el primer element del subvector a ordenar
* @param ultim indica l'últim element del subvector a ordenar
* @return void
*/
void Quicksort (int [] array, int esquerra, int dreta) {
...
void keyPressed () {
  ...
  switch (key) {
    case '1':  opcio = ENTERS;     break; 
    case '2':  opcio = CARACTERS;  break;
    case '3':  opcio = REINICIA;   break;
    case '4':  opcio = SEQUENCIAL; break;
    case '5':  opcio = BINARIA;    break;
    case '6':  opcio = SELECCIO;   break;
    case '7':  opcio = INSERCIO;   break;
    case '8':  opcio = BOMBOLLA;   break;
    case '9':  opcio = QUICKSORT;  break;
    case 'S':  opcio = SHELL;      break;
    case 's':  opcio = SHELL;      break;
    case 'C':  opcio = EFICIENCIA; break;
    case 'c':  opcio = EFICIENCIA; break;
